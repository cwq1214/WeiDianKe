...
import com.hzkj.wdk.widget.adapter.SelCityAdapter;
...
public class SelCityFragment extends BaseFragment {
    ...
    String result;
    SelCityCallback cityCallback;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_selcity, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(adapter = new SelCityAdapter());
        adapter.setOnViewHolderClickListener(new SelCityAdapter.OnViewHolderClickListener() {
            @Override
            public void onClick(Object data, int position) {
                if (data instanceof Province){
                    result = ((Province) data).name;
                    if (((Province) data).city==null){
                        cityCallback.sel(result);
                        mActivity.backFragment();
                    }else {
                        adapter.setDatas(((Province) data).city);
                        adapter.notifyDataSetChanged();
                    }
                }else if (data instanceof Province.City){
                    if (result.equals(((Province.City) data).name)){

                    }else {
                        result += " - " + ((Province.City) data).name;
        ...
        adapter.setDatas((List) new Gson().fromJson(json,new TypeToken<List<Province>>(){}.getType()));
    }
    ...
    public interface SelCityCallback{
        void sel(String result);
    }
}
